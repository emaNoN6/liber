...
\paragraph{}{The geometric circles described above represent the systematized Solomonic tradition. However, older protective systems—particularly the Babylonian \textit{\gls{zisurru}} and related folk practices—demonstrate that \textit{material} boundaries function independently of geometric precision.}

The principle is simple: a continuous line of consecrated substance creates a threshold that spiritual entities cannot cross. The closure matters more than the shape. An irregular but unbroken circle of salt functions as effectively as a perfectly scribed geometric form.

\textbf{Traditional Materials:}

\begin{itemize}
	\item \textbf{Salt:} Preservative and purifier. Represents incorruption and boundary definition.
	\item \textbf{Flour:} Substance of life and cultivation. The Babylonian \textit{\gls{maqlu}} texts specify different grain types for different entity classes.
	\item \textbf{Iron filings:} Disruptive to spiritual cohesion. Creates active discomfort rather than passive barrier.
	\item \textbf{Ash from specific woods:} Rowan, hazel, elder. Regional variations exist.
\end{itemize}

\textbf{Construction:}

Pour an unbroken line around the space to be protected. The line need not be thick—a finger's width suffices. What matters is continuity. Any gap, even a hand's breadth, renders the boundary permeable.

For outdoor work or situations where drawing is impractical, this method proves superior to chalk or ink. Wind and weather do not erase poured salt. Rain may dissolve it, but the physical presence persists longer than drawn lines.

\textbf{Mechanism:}

Spiritual entities do not perceive matter as humans do. To them, the salt line is not mere sodium chloride—it is a threshold of \textit{definition}, a boundary between ordered space (inside) and unordered space (outside). The material itself carries meaning independent of geometric form.

This is not symbolic. The texts are explicit: the circle works because it closes, and the substance works because it \textit{is}. Combine both—a geometrically correct circle poured in salt—and the effect multiplies.
