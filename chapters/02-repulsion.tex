...
\paragraph{}{The geometric circles described above represent the systematized Solomonic tradition. However, older protective systems—particularly the Babylonian \textit{zisurrû} and related folk practices—demonstrate that \textit{material} boundaries function independently of geometric precision.}
...
\begin{itemize}
	...
	\item \textbf{Flour:} Substance of life and cultivation. The Babylonian \textit{Maql\^{u}} texts specify different grain types for different entity classes.
